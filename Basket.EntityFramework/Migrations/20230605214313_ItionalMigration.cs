...
{
    /// <inheritdoc />
    public partial class ItionalMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    latatiude = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    longatiude = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastUpdatedById1 = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MainCatogries_AspNetUsers_CreatedById1",
                        column: x => x.CreatedById1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MainCatogries_AspNetUsers_LastUpdatedById1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainCatogryId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedById = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedById1 = table.Column<int>(type: "int", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stores_AspNetUsers_CreatedById1",
                        column: x => x.CreatedById1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Stores_AspNetUsers_LastUpdatedById1",
                        column: x => x.LastUpdatedById1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Stores_MainCatogries_MainCatogryId",
                        column: x => x.MainCatogryId,
                        principalTable: "MainCatogries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Categories_AspNetUsers_LastUpdatedById1",
                        column: x => x.LastUpdatedById1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Categories_MainCatogries_MainCatogryId",
                        column: x => x.MainCatogryId,
                        principalTable: "MainCatogries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavouriteStoreLists", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_LastUpdatedById1",
                table: "Categories",
                column: "LastUpdatedById1");

            migrationBuilder.CreateIndex(
                name: "IX_Categories_MainCatogryId",
                table: "Categories",
                column: "MainCatogryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MainCatogries_CreatedById1",
                table: "MainCatogries",
                column: "CreatedById1");

            migrationBuilder.CreateIndex(
                name: "IX_MainCatogries_LastUpdatedById1",
                table: "MainCatogries",
                column: "LastUpdatedById1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stores_CreatedById1",
                table: "Stores",
                column: "CreatedById1");

            migrationBuilder.CreateIndex(
                name: "IX_Stores_LastUpdatedById1",
                table: "Stores",
                column: "LastUpdatedById1");

            migrationBuilder.CreateIndex(
                name: "IX_Stores_MainCatogryId",
                table: "Stores",
                column: "MainCatogryId");
